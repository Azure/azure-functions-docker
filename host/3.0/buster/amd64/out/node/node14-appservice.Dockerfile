...
## Removed find /workers/node/grpc/src/node/extension_binary/ -mindepth 1 -type d ! -regex ".*linux-x64.*" -prune -exec rm -rf '{}' \;
# This line removes grpc stuff built for unsupported x64 builds. Can probably delete from main host dockerfile.  need to inventory 
